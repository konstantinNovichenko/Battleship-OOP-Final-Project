...
public class PlayerBoard extends Board{
	...
	public PlayerBoard()
	{
    	...
    	VBox rightSide = new VBox (20,playGame);
    	VBox leftSide = new VBox(20, horizontalPlacementButton, verticalPlacementButton,
    			placeAircraftCarrier, placeBattleship, placeCruiser, placeSubmarine, placeDestroyer);
    	//VBox that contains all ship placement GUI
    	placeShipsMenu = new HBox(20, leftSide, rightSide);
	 ...
	 * 
	 * @return leaderBoard : Leaderboard that represents a player leaderboard
	 */
    ...
    public void endGame()
    {
    	...
    	else //won
    	{
    		...
    		leaderBoard.updateLeaderboard(getRoundCounter(), (int)totalTimeInSec);
