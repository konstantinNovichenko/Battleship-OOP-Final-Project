...
public class Leaderboard {
	...
	public Leaderboard() {
		...
		file = new File("src\\GamesHistory.txt");
	}
	 ...
	 */
	public void updateLeaderboard(int turns, int seconds) {
		getList();		
		insertNewGame(turns, seconds);
		uploadList();
	}
	 ...
	 * @param seconds	->	int seconds taken by the player to win the game
	 */
	private void insertNewGame(int turns, int seconds) {
		...
		String[] newGame = {playerName, String.valueOf(turns), String.valueOf(seconds)};
